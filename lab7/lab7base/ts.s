...
// done this in svc.c, so no need here
// replace saved uR0 on stack with return value r from svc_handler()
...
switchPgdir:	// switch pgdir to new PROC's pgdir; passed in r0
  ...
  mov r0, #0x5                // AP=0101 for CLIENT: check page AP bits
  mcr p15, 0, r0, c3, c0, 0
